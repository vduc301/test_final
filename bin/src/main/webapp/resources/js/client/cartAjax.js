...
function changeQuanity(id,value,price)
	{
		$.ajax({
			type: "GET",		
			url: "http://localhost:8088/laptopshop/api/gio-hang/changSanPhamQuanity?id="+id+"&value="+value,
...
function deleteFromCart(id)
{
	$.ajax({
		type: "GET",		
		url: "http://localhost:8088/laptopshop/api/gio-hang/deleteFromCart?id="+id,
		success: function(result){
