		...
		<div class="wrap">
			...
			<div class="logo">
				<a href="<%=request.getContextPath()%>/"><img
					src="Frontend/img/logo3.png" title="logo" style="width: 200px; height: 80px;" /></a>
			</div>
			<!----end-logo---->
			<!----start-top-nav---->
			<div class="top-nav">
				<ul>
					<li><a class="nav-item" href="<%=request.getContextPath()%>/">Trang chủ</a></li>

					<li class="dropdown"><a class="dropdown-toggle nav-item" data-toggle="dropdown" href="#">Cửa hàng <span class="caret"></span></a>
						<ul class="dropdown-menu" style="background: #FFD154" id="danhmuc2">
						</ul></li>
					<li><a class="nav-item" href="<%=request.getContextPath()%>/shipping">Miễn
							phí vận chuyển</a></li>
					<li><a class="nav-item" href="<%=request.getContextPath()%>/guarantee">Bảo
							hành tận nơi</a></li>
				</ul>
			</div>
			<div class="clear"></div>
